...
def main():
	...
	for idx, tf in enumerate(test_files):
		...
		num_vehicles, num_calls, best_solution, best_cost, seeds = local_search_sim_annealing_latex(problem=prob, init_sol = init_sol, num_of_iterations=10000, num_of_rounds=1, allowed_neighbours=neighbours, method="aa", file_num=idx+1, statistics=True)
