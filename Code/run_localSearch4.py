...
def main():
	...
	#test_files = ["../Data/Call_18_Vehicle_5.txt"]
	test_files = ["../Data/Call_35_Vehicle_7.txt"]
	...
	for tf in test_files:
		...
		#break
		num_vehicles, num_calls, best_solution, best_cost, seeds = local_search_sim_annealing_latex(problem=prob, init_sol = init_sol, num_of_iterations=10000, num_of_rounds=10, allowed_neighbours=[1,2,6], probabilities = [1,1,1], method="isa")
