...
def main():
	...
	for tf in test_files:
		...
		neighbours = [4, 5, 6]
		num_vehicles, num_calls, best_solution, best_cost, seeds = local_search_sim_annealing_latex(problem=prob, init_sol = init_sol, num_of_iterations=10000, num_of_rounds=3, allowed_neighbours=neighbours, probabilities = [1]*len(neighbours), method="isa")
